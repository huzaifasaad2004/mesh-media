...
import { Save, RotateCcw, ShieldCheck, ArrowRight, Activity, ListChecks, Plug, GitBranch } from 'lucide-react'
  ...
  return (
    <div>
      ...
      <div className="grid grid-cols-1 gap-6 max-w-3xl">
        ...
        <Link href="/settings/automations" className="card p-6 flex items-center justify-between hover:shadow-md transition-shadow">
          <div className="flex items-center gap-3">
            <div className="w-9 h-9 bg-brand-50 rounded-lg flex items-center justify-center flex-shrink-0">
              <GitBranch className="w-4.5 h-4.5 text-brand-600" />
            </div>
            <div>
              <h3 className="font-semibold text-gray-900">Workflow Automations</h3>
              <p className="text-xs text-gray-500 mt-0.5">Build reliable when-this-happens workflows without code</p>
            </div>
          </div>
        ...
        {/* Access control */}
        <Link href="/settings/permissions" className="card p-6 flex items-center justify-between hover:shadow-md transition-shadow">
          <div className="flex items-center gap-3">
            <div className="w-9 h-9 bg-brand-50 rounded-lg flex items-center justify-center flex-shrink-0">
            ...
            <div>
              ...
              <p className="text-xs text-gray-500 mt-0.5">Control what each role can see and do, role by role</p>
            </div>
          </div>
          <ArrowRight className="w-4 h-4 text-gray-300 flex-shrink-0" />
        </Link>

        <Link href="/settings/onboarding-templates" className="card p-6 flex items-center justify-between hover:shadow-md transition-shadow">
          <div className="flex items-center gap-3">
            <div className="w-9 h-9 bg-brand-50 rounded-lg flex items-center justify-center flex-shrink-0">
              <ListChecks className="w-4.5 h-4.5 text-brand-600" />
            </div>
            <div>
              <h3 className="font-semibold text-gray-900">Onboarding Templates</h3>
              <p className="text-xs text-gray-500 mt-0.5">Reusable checklists to start a client's onboarding run</p>
            </div>
          </div>
          <ArrowRight className="w-4 h-4 text-gray-300 flex-shrink-0" />
        </Link>

        <Link href="/settings/activity" className="card p-6 flex items-center justify-between hover:shadow-md transition-shadow">
          <div className="flex items-center gap-3">
            <div className="w-9 h-9 bg-brand-50 rounded-lg flex items-center justify-center flex-shrink-0">
